...
<div class="clearfix">
  <div class="column sidemenu">
    ...
    <ul>
      <li>Agent</li>
      <li><a href="addstaff.php" class="active">Ajouter un membre agent</a></li>
    ...
    <div class="marwa">    
     <p>
        <form action="add_staff.php" method="POST">
          ...
          Mobile 
          <br>
          <input type="text" name="staff_mobile" required=""/>
          <br><br><br>
          Email
          <br>
          ...
          Mot De Passe
          <br>
          <input type="password" name="staff_pwd" required=""/>
          <br><br><br>
          <input type="submit" name="add_staff" value="AJOUTER" class='addstaff_button'/>
        </form><br>
      </p>
      <br><br>
    </div>
