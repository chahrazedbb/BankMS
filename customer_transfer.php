...
<div class="clearfix">
  <div class="column sidemenu">
    ...
    <ul>
      ...
      <li><a href="customer_transfer.php"  class="active" >Transfert du fonds</a></li>
    </ul>
    <ul>
  ...
  <div class="column content">
    ...
    <p>
      ...
      ?>
        ...
        <br><br><br>
        <input type='number' name='t_val' required placeholder="Enter Montant">
        <br><br><br>
        <input type='submit' name='submitBtn' value='Transfer'>
        </form> 
        <?php }
          else{
              echo "<br><br><div class='head'><h3>N° du Bénéficiaire ajouté à votre compte.</h3></div>";
          }
        ?>
    </p> 
    <br><br>   
