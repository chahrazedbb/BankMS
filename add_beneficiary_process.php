...
<?php
                ...
                {
                echo '<script>alert("vous ne pouvez pas vous ajouter comme un beneficiaire!");';
                     echo 'window.location= "add_beneficiary.php";</script>';
                }
                
                elseif($s1==$sender_id && $s2==$acc_no)
                {
                    echo '<script>alert("vous ne pouez pas ajouter un beneficiaire 2 fois!");';
                     echo 'window.location= "add_beneficiary.php";</script>';
                }
                
                elseif($rws[1]!=$Payee_name && $rws[0]!=$acc_no && $rws[11]!=$branch && $rws[12]!=$ifsc)
                {
                echo '<script>alert("Beneficiaire n\'exicte pas!\n S\'il vous plais  enterez des informations correctes");';
                     echo 'window.location= "add_beneficiary.php";</script>';
                }
