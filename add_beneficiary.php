...
<div class="clearfix">
  <div class="column sidemenu">
    ...
    <ul>
      ...
      <li><a href="add_beneficiary.php" class="active" >Ajouter un Bénéficiaire</a></li>
  ...
  <div class="column content">
    ...
    <p>
      <form action='add_beneficiary_process.php' method='post'>
        <input type='text' name='name' required placeholder="Nom du beneficiaire">
        <br/> <br/> <br/>
        <input type='text' name='account_no' required placeholder="N° du compte">
        <br/> <br/> <br/>
        ...
        <br/> <br/> <br/>
       <input type='text' name='ifsc_code' required placeholder="Code Ifsc">
       <br/> <br/> <br/>
